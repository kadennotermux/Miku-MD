...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: GingerBreadSketchy to take your WhatsApp usage into next level.
...
case 'repo': case 'botrepo':
    ...
    reply(`*My Source Code:* https://github.com/GingerBreadSketchy`)
    break
...
case 'play2': case 'ytplay2': {
    ...
    {buttonId: `-ytmp3 ${anu.url}`, buttonText: {displayText: '♫ Audio'}, type: 1}
                    ...
                    let buttonMessage = {
                        ...
                        caption: `「 _Sketchy Youtube Player_ 」
...
textyt = `「 _Sketchy Youtube Downloader_ 」
Title : ${res.title}
Size : ${res.size}
Quality : ${res.quality}
...
case 'add':{     			
 ...
 case "tts":  case "texttospeech":  case "say": case "speak":{
    ...
    var replqr =  await getBuffer(`https://miku-qr--GingerBreadSketchy.repl.co/`)
                               var qrbutton = [
